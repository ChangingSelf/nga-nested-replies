  ...
  plugins: [
    monkey({
      ...
      userscript: {
        ...
        license: 'MIT',
        downloadURL:
          'https://update.greasyfork.org/scripts/554439/NGA%20%E6%A5%BC%E4%B8%AD%E6%A5%BC.user.js',
        updateURL:
          'https://update.greasyfork.org/scripts/554439/NGA%20%E6%A5%BC%E4%B8%AD%E6%A5%BC.meta.js',
      },
      build: {
